...
/**
 * AppPricePointAttributes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AppPricePointAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppPricePoint_attributes';
    ...
    {
        $this->container['customer_price'] = isset($data['customer_price']) ? $data['customer_price'] : null;
     ...
     * Sets customer_price
     *
     * @param string|null $customer_price customer_price
     *
     * @return $this
     */
     ...
     * Sets proceeds
     *
     * @param string|null $proceeds proceeds
     *
     * @return $this
     */
